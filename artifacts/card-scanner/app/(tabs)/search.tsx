  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      {loading ? (
        ...
        <View style={styles.centered}>
          <Ionicons name="search-outline" size={52} color={colors.mutedForeground + "60"} />
        ...
        <View style={styles.centered}>
          <Ionicons name="file-tray-outline" size={52} color={colors.mutedForeground + "60"} />
          <Text style={[styles.emptyText, { color: colors.mutedForeground }]}>
